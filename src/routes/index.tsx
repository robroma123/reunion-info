  ...
  return (
    <div className="min-h-screen bg-[#f5f3ef] text-gray-800">
      ...
      <div className="bg-amber-100 border-b-2 border-amber-300 px-5 pt-20 pb-6 text-center">
        ...
        <h2 className="text-lg md:text-xl font-bold text-amber-900 mt-6 mb-2">About This Page</h2>
        <p className="text-sm md:text-base text-amber-900 leading-snug max-w-4xl mx-auto">
          My name is Robert Romano. I'm a licensed healthcare provider and IPI graduate who attended a Reunion retreat about two years ago. After my own profound retreat experience at Reunion—which genuinely transformed my life—I've been discussing this venue with other IPI graduates and friends of IPI for nearly two years. Several colleagues asked me to share the materials Haamid, Reunion Director of Enrollment, provided and so I created this page.
        </p>
