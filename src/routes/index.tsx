          ...
          <div className="space-y-12">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-4 bg-[#2d6a6a] text-white flex items-center justify-between">
                ...
                <a href="/reunion_1_2.pdf" download className="hidden sm:inline-block text-sm bg-amber-400 text-gray-900 px-4 py-2 rounded hover:bg-amber-300 transition-colors">Download PDF</a>
                {/* Mobile: Tap to view button */}
                <a href="/reunion_1_2.pdf" target="_blank" rel="noopener noreferrer" className="sm:hidden inline-flex items-center gap-1 text-sm bg-amber-400 text-gray-900 px-4 py-2 rounded hover:bg-amber-300 transition-colors">
                  Tap to View
                  <ExternalLink className="w-4 h-4" />
                </a>
              </div>
              {/* Desktop/Tablet: iframe */}
              <div className="hidden sm:block aspect-[4/3] w-full">
              ...
              <div className="sm:hidden aspect-[4/3] w-full">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-4 bg-[#2d6a6a] text-white flex items-center justify-between">
                ...
                {/* Desktop: Download button */}
                <a href="/reunion_2_2.pdf" download className="hidden sm:inline-block text-sm bg-amber-400 text-gray-900 px-4 py-2 rounded hover:bg-amber-300 transition-colors">Download PDF</a>
                {/* Mobile: Tap to view button */}
                <a href="/reunion_2_2.pdf" target="_blank" rel="noopener noreferrer" className="sm:hidden inline-flex items-center gap-1 text-sm bg-amber-400 text-gray-900 px-4 py-2 rounded hover:bg-amber-300 transition-colors">
                  Tap to View
                  <ExternalLink className="w-4 h-4" />
                </a>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-4 bg-[#2d6a6a] text-white flex items-center justify-between">
                ...
                {/* Desktop: Download button */}
                <a href="/reunion_pricing.pdf" download className="hidden sm:inline-block text-sm bg-amber-400 text-gray-900 px-4 py-2 rounded hover:bg-amber-300 transition-colors">Download PDF</a>
                {/* Mobile: Tap to view button */}
                <a href="/reunion_pricing.pdf" target="_blank" rel="noopener noreferrer" className="sm:hidden inline-flex items-center gap-1 text-sm bg-amber-400 text-gray-900 px-4 py-2 rounded hover:bg-amber-300 transition-colors">
                  Tap to View
                  <ExternalLink className="w-4 h-4" />
                </a>
              </div>
