      ...
      <nav className="fixed top-0 left-0 right-0 z-50">
        <div className="bg-[#2d6a6a]/95 backdrop-blur-sm shadow-md">
          <div className="max-w-6xl mx-auto px-1 md:px-6 py-3 flex items-center justify-center gap-1.5 md:gap-5">
            ...
            <button onClick={() => scrollToSection('pricing')} className="text-white/80 hover:text-white text-xs md:text-sm font-medium transition-colors"><span className="md:hidden">Pricing</span><span className="hidden md:inline">Estimated Pricing</span></button>
            <button onClick={() => scrollToSection('faq')} className="text-white/80 hover:text-white text-xs md:text-sm font-medium transition-colors">FAQ's</button>
            <button onClick={() => scrollToSection('interest')} className="text-white/80 hover:text-white text-xs md:text-sm font-medium transition-colors">Contact Us</button>
          </div>
        </div>
      </nav>
...
export const Route = createFileRoute('/april2026')({
  component: April2026Page,
  head: () => ({
    meta: [
      {
        title: 'Reunion Costa Rica | April 13-18 Information',
      },
      {
        property: 'og:title',
        content: 'Reunion Costa Rica | April 13-18 Information',
      },
      {
        property: 'og:description',
        content: 'Five days at an oceanfront wellness resort in Costa Rica\'s Blue Zone — rest, connection, and renewal with friends, family, and colleagues. April 13–18, 2026.',
      },
      {
        property: 'og:image',
      ...
      {
        property: 'og:url',
        content: 'https://retreats.robromano.com/april2026',
      },
      {
        property: 'og:type',
        content: 'website',
