...
import { MapPin, Users, Star, Calendar, Bed, UtensilsCrossed, Dumbbell, Mail, Phone, ExternalLink, ChevronDown } from 'lucide-react'
...
function ReunionPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f3ef] text-gray-800">
      ...
      <section className="py-24 px-6 bg-[#2d6a6a] text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-light mb-8">Let's Co-Create an Unforgettable Experience</h2>
          <p className="text-lg text-gray-200 leading-relaxed mb-12 max-w-2xl mx-auto">Ready to learn more about hosting your retreat at Reunion? Reach out to the team to schedule a discovery call or request the full hosting information PDF.</p>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-12">
            <a href="mailto:haamid.dash@reunionwellness.org" className="flex items-center gap-3 bg-white/10 hover:bg-white/20 px-6 py-4 rounded-sm transition-colors">
              <Mail className="w-5 h-5 text-amber-300" />
              <span>haamid.dash@reunionwellness.org</span>
            </a>
            <a href="tel:+18888191191" className="flex items-center gap-3 bg-white/10 hover:bg-white/20 px-6 py-4 rounded-sm transition-colors">
              <Phone className="w-5 h-5 text-amber-300" />
              <span>+1 888-819-1191</span>
            </a>
          </div>
          <a href="https://www.reunionwellness.org/host-a-retreat" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-amber-400 hover:bg-amber-300 text-gray-900 px-10 py-4 rounded-sm text-lg font-medium transition-all duration-300">
      ...
      <footer className="py-8 px-6 bg-gray-900 text-gray-400 text-center text-sm">
        <p>Reunion Wellness Resort & Retreats</p>
        <p className="mt-2">Sugar Beach, Guanacaste, Costa Rica</p>
        <p className="mt-4 text-gray-500">
          <a href="https://www.reunionwellness.org" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">www.reunionwellness.org</a>
        </p>
      </footer>
    </div>
  )
