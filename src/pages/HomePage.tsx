...
import { MapPin, Users, Star, Calendar, Bed, UtensilsCrossed, Dumbbell, ExternalLink, ChevronDown, ChevronUp, FolderOpen, Play } from 'lucide-react'
      ...
      <nav className="fixed top-0 left-0 right-0 z-50">
        <div className="bg-[#2d6a6a]/95 backdrop-blur-sm shadow-md">
          <div className="max-w-6xl mx-auto px-2 md:px-6 py-3 flex items-center justify-center gap-2 md:gap-6">
            <a href="#ipi-friends" className="text-white/80 hover:text-white text-xs md:text-sm font-medium transition-colors">IPI/Friends</a>
            <a href="#featured-video" className="text-white/80 hover:text-white text-xs md:text-sm font-medium transition-colors">Video</a>
            <a href="#explore" className="text-white/80 hover:text-white text-xs md:text-sm font-medium transition-colors">Explore</a>
            <a href="#pricing" className="text-white/80 hover:text-white text-xs md:text-sm font-medium transition-colors">Pricing</a>
            <a href="#faq" className="text-white/80 hover:text-white text-xs md:text-sm font-medium transition-colors">FAQ</a>
            <a href="#contact" className="text-white/80 hover:text-white text-xs md:text-sm font-medium transition-colors">Contact</a>
          </div>
        </div>
      </nav>
